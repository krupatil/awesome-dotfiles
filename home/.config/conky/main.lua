...
function conky_main(  )
	...
	--draw_image(ir, centerx, centery, face_radius, pathway.."ubuntu_1");
	draw_image(ir, centerx, centery, face_radius, pathway.."krunal_avtar");
	--draw_image(ir, centerx, centery, face_radius, pathway.."ubuntu_2");
	--draw_image(ir, centerx, centery, face_radius, pathway.."linux_mint_1");
	--draw_image(ir, centerx, centery, face_radius, pathway.."linux_mint_2");
	--draw_image(ir, centerx, centery, face_radius, pathway.."linux_mint_3");
	--draw_image(ir, centerx, centery, face_radius, pathway.."ubuntu_1");
